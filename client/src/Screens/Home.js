...
class Home extends React.Component {
  ...
  animate() {
    Animated.loop(Animated.timing(this.animatedIcon, {
      toValue: 1,
      duration: 1300,
  ...
  renderPet(pet, index) {
    ...
    return (<TouchableHighlight onPress={() => {
      ...
      }} underlayColor='transparent' key={pet.petId}>
      <View style={styles.petInfoContainer}>
        <Image resizeMode='cover' source={uri
            ? {
              uri
            }
            : require('../../assets/images/profileicon.png')} style={styles.petInfoAvatar}/>
    ...
    return (<View style={[{
      ...
      ]}>
      {
        !loading && <View style={{
            ...
            <Icon onPress={this.toggleModal} raised="raised" reverse="reverse" name='add' size={44} containerStyle={{
                width: 50,
                height: 50
      ...
      <ScrollView style={[{
        ...
        ]}>
        {
          loading && <Animated.View style={{
              ...
              }}><Icon name='autorenew' color={colors.grayIcon}/></Animated.View>
        }
        {
...
const HomeRouteStack = {
  Home: {
    ...
    navigationOptions: (props) => {
      return {title: 'Home', headerLeft: <SideMenuIcon onPress={() => props.screenProps.rootNavigator.navigate('DrawerOpen')}/>}
    }
  },
  ViewPet: {
    screen: ViewPet
